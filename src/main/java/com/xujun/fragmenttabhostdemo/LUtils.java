...
public class LUtils {
    ...
    private static DateFormat formatter = new SimpleDateFormat("yyyy-MM-dd", Locale
            .SIMPLIFIED_CHINESE);
    ...
    private static String generateTag(StackTraceElement caller) {
        ...
        tag = String.format(Locale.ENGLISH, tag, callerClazzName, caller.getMethodName(), caller
                .getLineNumber()); // 替换
    ...
    private static final ThreadLocal<ReusableFormatter> thread_local_formatter = new
